...
<?php 
    ...
    while($statusmodalrow = mysqli_fetch_assoc($statusmodalresult)){
        ...
        if ($status == 0) 
            $tstatus = "Pemesanan Dilakukan.";
        elseif ($status == 1) 
            $tstatus = "Pesanan Dikonfirmasi.";
        elseif ($status == 2)
            $tstatus = "Pesanan Sedang Diproses.";
        elseif ($status == 3)
            $tstatus = "Sedang Dikirim.";
        elseif ($status == 4) 
            $tstatus = "Tiba Di Tempat.";
        elseif ($status == 5) 
        ...
        if($status >= 1 && $status <= 4) {
            ...
            // Check if data exists before accessing array keys
            if($deliveryDetailRow !== null) {
                ...
                $trackId = 'Belum tersedia';
                $deliveryBoyName = 'Belum ditentukan';
                $deliveryBoyPhoneNo = 'Belum tersedia';
                $deliveryTime = 'Belum ditentukan';
            }
        }
        else {
            $trackId = 'xxxxx';
                ...
                <div class="container" style="padding-right: 0px;padding-left: 0px;">
                    <article class="card">
                        <div class="card-body">
                            ...
                            <?php
                                if($status == 0){
                                      echo '<div class="step active"> <span class="icon"> <i class="fa fa-check"></i> </span> <span class="text">Pemesanan Dilakukan</span> </div>
                                            <div class="step"> <span class="icon"> <i class="fa fa-times"></i> </span> <span class="text">Pesanan Dikonfirmasi</span> </div>
                                            <div class="step"> <span class="icon"> <i class="fa fa-times"></i> </span> <span class="text">Pesanan Sedang Diproses</span> </div>
                                            <div class="step"> <span class="icon"> <i class="fa fa-truck"></i> </span> <span class="text"> Sedang Dikirim </span> </div>
                                            <div class="step"> <span class="icon"> <i class="fa fa-box"></i> </span> <span class="text">Tiba di Lokasi</span> </div>';
                                }
                                elseif($status == 1){
                                    echo '<div class="step active"> <span class="icon"> <i class="fa fa-check"></i> </span> <span class="text">Pemesanan Dilakukan</span> </div>
                                ...
                                elseif($status == 2){
                                    echo '<div class="step active"> <span class="icon"> <i class="fa fa-check"></i> </span> <span class="text">Pemesanan Dilakukan</span> </div>
                                          <div class="step active"> <span class="icon"> <i class="fa fa-check"></i> </span> <span class="text">Pesanan Dikonfirmasi</span> </div>
                                          <div class="step active"> <span class="icon"> <i class="fa fa-check"></i> </span> <span class="text"> Pesanan Sedang Diproses</span> </div>
                                          <div class="step"> <span class="icon"> <i class="fa fa-truck"></i> </span> <span class="text"> Sedang Dikirim </span> </div>
                                          <div class="step"> <span class="icon"> <i class="fa fa-box"></i> </span> <span class="text">Tiba di Lokasi</span> </div>';
                                }
                                elseif($status == 3){
                                    echo '<div class="step active"> <span class="icon"> <i class="fa fa-check"></i> </span> <span class="text">Pemesanan Dilakukan</span> </div>
                                          <div class="step active"> <span class="icon"> <i class="fa fa-check"></i> </span> <span class="text">Pesanan Dikonfirmasi</span> </div>
                                          <div class="step active"> <span class="icon"> <i class="fa fa-check"></i> </span> <span class="text"> Pesanan Sedang Diproses</span> </div>
                                          <div class="step active"> <span class="icon"> <i class="fa fa-truck"></i> </span> <span class="text"> Sedang Dikirim </span> </div>
                                          <div class="step"> <span class="icon"> <i class="fa fa-box"></i> </span> <span class="text">Tiba di Lokasi</span> </div>';
                                }
                                elseif($status == 4){
                                    echo '<div class="step active"> <span class="icon"> <i class="fa fa-check"></i> </span> <span class="text">Pemesanan Dilakukan</span> </div>
                                          ...
                                          <div class="step active"> <span class="icon"> <i class="fa fa-check"></i> </span> <span class="text"> Pesanan Sedang Diproses</span> </div>
                                          <div class="step active"> <span class="icon"> <i class="fa fa-truck"></i> </span> <span class="text"> Sedang Dikirim </span> </div>
                                          <div class="step active"> <span class="icon"> <i class="fa fa-box"></i> </span> <span class="text">Tiba di Lokasi</span> </div>';
                                } 
                                elseif($status == 5){
                                    echo '<div class="step active"> <span class="icon"> <i class="fa fa-check"></i> </span> <span class="text">Pemesanan Dilakukan</span> </div>
                                          <div class="step deactive"> <span class="icon"> <i class="fa fa-times"></i> </span> <span class="text">Pesanan Ditolak.</span> </div>';
                                }
                                else {
                                    echo '<div class="step deactive"> <span class="icon"> <i class="fa fa-times"></i> </span> <span class="text">Pesanan Dibatalkan.</span> </div>';
                                }
                            ?>
                            </div>
