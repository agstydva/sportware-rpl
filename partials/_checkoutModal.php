...
<div class="modal fade" id="checkoutModal" tabindex="-1" role="dialog" aria-labelledby="checkoutModal" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        ...
        <div class="modal-header">
            <h5 class="modal-title" id="checkoutModal">Order</h5>
        ...
        <div class="modal-body">
            <form action="partials/_manageCart.php" method="post">
                <div class="form-group">
                    ...
                    <input class="form-control" id="address" name="address" placeholder="Jl. Pemuda 123" type="text" required minlength="3" maxlength="500">
                </div>
                <div class="form-group">
                    <b><label for="address1">Alamak 2:</label></b>
                    <input class="form-control" id="address1" name="address1" placeholder="Jl. Swasembada 123" type="text">
                </div>
                <div class="form-row">
                    <div class="form-group col-md-6 mb-0">
                        ...
                        <input type="tel" class="form-control" id="phone" name="phone" placeholder="08xxxxxxxx" required pattern="[0-9]{10}" maxlength="10">
                        </div>
                    </div>
                    <div class="form-group col-md-6 mb-0">
