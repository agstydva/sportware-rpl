                ...
                <form action="partials/_categoryManage.php" method="post" enctype="multipart/form-data">
                    <div class="card">
                        ...
                        <div class="card-footer">
                            <div class="row">
                                <div class="col-md-12">
                                    <button type="submit" name="createCategory" class="btn btn-sm btn-success col-sm-3 offset-md-4"> Create </button>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-md-8 mb-3">
                <div class="card">
                    ...
                    <table class="table table-bordered table-hover mb-0">
                        ...
                        <tr>
                            <th class="text-center" style="width:7%;"><h3><b>Id</b></h3></th>
                            <th class="text-center"><h3><b>Img</b></h3></th>
                            <th class="text-center" style="width:58%;"><h3><b>Category Detail</b></h3></th>
                            <th class="text-center" style="width:18%;"><h3><b>Edit</b></h3></th>
                        </tr>
                        </thead>
                        <tbody>
                        <?php 
                            ...
                            while($row = mysqli_fetch_assoc($result)){
                                ...
                                echo '<tr>
                                        ...
                                        <td><img src="/sportware/img/card-'.$catId. '.jpg" alt="image for this Category" width="150px" height="150px"></td>
                                        <td>
        ...
        <form action="partials/_categoryManage.php" method="post" enctype="multipart/form-data">
		    <div class="text-left my-2 row" style="border-bottom: 2px solid #dee2e6;">
				...
				<div class="form-group col-md-4">
					<img src="/sportware/img/card-<?php echo $catId; ?>.jpg" id="itemPhoto" name="itemPhoto" alt="Category image" width="100" height="100">
				</div>
			</div>
		</form>
        <form action="partials/_categoryManage.php" method="post">
