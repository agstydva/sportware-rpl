			...
			<form action="partials/_menuManage.php" method="post" enctype="multipart/form-data">
				<div class="card mb-3">
					...
					<div class="card-footer">
						<div class="row">
							<div class="mx-auto">
								<button type="submit" name="createItem" class="btn btn-sm btn-success"> Create </button>
							</div>
						</div>
					</div>
				</div>
                            ...
                            <?php
                                ...
                                while($row = mysqli_fetch_assoc($result)){
                                    ...
                                    echo '<tr>
                                            ...
                                            <td>
                                                <img src="/sportware/img/product-'.$productId. '.jpg" alt="image for this item" width="150px" height="150px">
                                            </td>
                                            <td>
                                                <p>Name : <b>' .$productName. '</b></p>
                                                <p>Description : <b class="truncate">' .$productDesc. '</b></p>
                                                <p>Price : <b>Rp' .$productPrice. '.000</b></p>
                                            </td>
                                            <td class="text-center">
												<div class="row mx-auto" style="width:112px">
													<button class="btn btn-sm btn-success" type="button" data-toggle="modal" data-target="#updateItem' .$productId. '">Edit</button>
	  	...
	  	<form action="partials/_menuManage.php" method="post" enctype="multipart/form-data">
		    <div class="text-left my-2 row" style="border-bottom: 2px solid #dee2e6;">
				...
				<div class="form-group col-md-4">
					<img src="/sportware/img/product-<?php echo $productId; ?>.jpg" id="itemPhoto" name="itemPhoto" alt="item image" width="100" height="100">
				</div>
			</div>
		</form>
		<form action="partials/_menuManage.php" method="post">
