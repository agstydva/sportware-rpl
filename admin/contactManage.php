<div class="alert alert-info alert-dismissible fade show" role="alert" style="width:100%" id='notempty'>
    <strong>Info!</strong> Harap Tinggalkan Pesan Jika Membatalkan Pesanan!	
                            ...
                            while($row=mysqli_fetch_assoc($result)) {
                                ...
                                echo '<tr>
                                        ...
                                        <td class="text-center">
                                            <button class="btn btn-sm btn-success" type="button" data-toggle="modal" data-target="#reply' .$contactId. '">Reply</button>
                                        </td>
                                    </tr>';
                            }
                            if($count==0) {
