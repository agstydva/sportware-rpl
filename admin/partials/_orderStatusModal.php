  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header" style="background-color: #FFD700;">
        <h5 class="modal-title" id="orderStatus<?php echo $orderid; ?>"><b>Order Status and Delivery Details</b></h5>
      ...
      <div class="modal-body">
        <form action="partials/_orderManage.php" method="post" style="border-bottom: 2px solid #dee2e6;">
            <div class="text-left my-2">    
                ...
                <button type="button" class="btn btn-secondary ml-1" data-container="body" data-toggle="popover" title="User Types" data-placement="bottom" data-html="true" data-content="0=Pemesanan Dilakukan.<br> 1=Pesanan Dikonfirmasi.<br> 2=Pesanan Sedang Diproses.<br> 3=Sedang Dikirim!.<br> 4=Tiba Di Tempat.<br> 5=Pesanan Ditolak.<br> 6=Pesanan Dibatalkan.">
        ...
        <?php 
            ...
            $trackId = $deliveryDetailRow ? $deliveryDetailRow['id'] : null;
            $deliveryBoyName = $deliveryDetailRow ? $deliveryDetailRow['deliveryBoyName'] : '';
            $deliveryBoyPhoneNo = $deliveryDetailRow ? $deliveryDetailRow['deliveryBoyPhoneNo'] : '';
            $deliveryTime = $deliveryDetailRow ? $deliveryDetailRow['deliveryTime'] : '';
            
            if($orderStatus>0 && $orderStatus<5) { 
        ?>
            <form action="partials/_orderManage.php" method="post">
                <div class="text-left my-2">
                    <b><label for="name">Nama Kurir</label></b>
                ...
                <div class="text-left my-2 row">
                    ...
                    <div class="form-group col-md-6">
                        <b><label for="catId">Estimasi Waktu (menit)</label></b>
