...
<html lang="en">
  ...
  <?php include 'partials/_nav.php';?>
      ...
      <div class="contact2" style="background-image:url(assets/img/slide/slide-42.jpg); height: 700px; background-size: auto 100%" id="contact">
        <div class="container">
                ...
                <div class="row">
                  <div class="col-lg-8">
                    <div class="contact-box p-4">
                      <div class="row">
                        <div class="col-lg-8">
                          <h4 class="title">Contact Us @sportware</h4>
                        </div>
                        <?php if($loggedin){ ?>
                          <div class="col-lg-4">
                      ...
                      <form action="partials/_manageContactUs.php" method="POST">
                        <div class="row">
                          ...
                          <div class="col-lg-12">
                            <div class="form-group  mt-3">
                                <textarea class="form-control" id="message" name="message" rows="2" required minlength="6" placeholder="Ada Keluhan Apach ?"></textarea>
                            </div>
                          </div>
                          <?php if($loggedin){ ?>
                            <div class="col-lg-12">
                          ...
                          <?php }else { ?>
                            <div class="col-lg-12">
                              ...
                              <small class="form-text text-muted">Login dulu ya cik.</small>
                            </div>
                          <?php } ?>
                        </div>
                      </form>
                  ...
                  <?php
                    ...
                    echo '<div class="col-lg-4 bg-image" style="background-image:url(assets/img/slide/slide-olhar3.jpg)">
              ...
              <table class="table-striped table-bordered col-md-12 text-center">
                ...
                <?php 
                    if($loggedin && $userId > 0) {
                        ...
                        echo '<tr><td colspan="3">Please login to view messages</td></tr>';
                    }
                ?>
                </tbody>
		          </table>
              ...
              <table class="table-striped table-bordered col-md-12 text-center">
                ...
                <?php 
                    if($loggedin && $userId > 0) {
                        ...
                        echo '<tr><td colspan="4">Please login to view history</td></tr>';
                    }
                ?>
                </tbody>
		          </table>
